...
export default function Signup() {
  ...
  const onSubmit = (values: z.infer<typeof signupSchema>) => {
    signupMutation.mutate({ data: values }, {
      ...
      onError: (error) => {
        form.setError("root", { message: error.error?.error || "Signup failed" });
      }
    });
  };
    ...
    <div className="min-h-[100dvh] flex items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>Get started with your Copilot</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
          ...
          <div className="mt-6">
            ...
            <Button variant="outline" type="button" className="w-full mt-4" data-testid="button-google">
